...
<section id="login" class="login">
  <div class="container" data-aos="fade-up">
    ...
    <div class="section-title">
      ...
      <h2>S'inscrire</h2>
      <p>Profitez de votre temps libre pour apprendre auprès des meilleures universités et entreprises.</p>
    </div>
        ...
        <form action="forms/contact.php" method="post" role="form" class="php-email-form">
          ...
          <div class="row">
            ...
            <div class="form-group col-md-12">
              ...
              <input type="text" class="form-control" name="name" id="name" placeholder="Saisir votre nom et prénom" required>
            </div>
            ...
            <div class="form-group col-md-12">
              ...
              <input type="password" name="yourpassword" class="form-control" id="yourpassword" placeholder="Saisir votre mot de passe" required>
              <span class="text-danger" style="font-size: 12px;">Entre 8 et 72 caractères</span>
            </div>

            
            <div class="form-group col-md-12">
              <label for="conf_password">Confirmation</label>
              <input type="password" name="conf_password" class="form-control" id="conf_password" placeholder="Confirmer votre mot de passe" required>
            </div>

          </div>

          <div class="text-center"><button class="btn-submit" type="submit">S'inscrire</button></div>
    ...
    <div class="row mt-3 d-flex justify-content-center">
      <div class="col-sm-8 col-md-6 col-lg-5 mt-lg-0 d-flex justify-content-center">
        <p class="text-center">Vous utilisez déjà {{env('APP_NAME', 'NZCONSEILS')}} ? <a href="{{route('login')}}">Connexion</a> </p>
      </div>
    </div>
